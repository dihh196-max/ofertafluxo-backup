const definitions = [
  ...
  ['tools-bbq', 'Ferramentas, utilidades e churrasco', 'kit ferramentas', ['ferramenta', 'ferramentas', 'furadeira', 'parafusadeira', 'parafuso', 'chave de fenda', 'chave philips', 'chave inglesa', 'chave catraca', 'alicate', 'martelo', 'trena', 'serrote', 'broca', 'lixadeira', 'esmerilhadeira', 'maleta ferramenta', 'kit ferramenta', 'bancada', 'churrasco', 'churrasqueira', 'grelha', 'espeto', 'espetinho', 'faca churrasco', 'kit churrasco', 'tabua churrasco', 'tábua churrasco', 'pegador churrasco', 'avental churrasco', 'acendedor'], ['brinquedo', 'infantil', 'miniatura', 'fantasia', 'maquiagem', 'unha'], ['furadeira parafusadeira', 'kit ferramentas', 'alicate chave de fenda', 'churrasqueira grelha', 'kit churrasco']],
  ...
  ['fashion-women', 'Moda feminina — roupas', 'vestido feminino', ['vestido', 'vestidos', 'short', 'shorts', 'conjunto', 'conjuntos', 'blusa', 'blusas', 'cropped', 'croppeds', 'calça', 'calcas', 'saia', 'saias', 'macacão', 'macacao', 'macaquinho', 'camisa feminina', 'camiseta feminina', 'pijama', 'jaqueta feminina', 'casaco feminino', 'cardigan', 'body feminino', 'top feminino', 'lingerie', 'sutiã', 'sutia', 'calcinha', 'camisola', 'baby doll', 'babydoll'], ['bolsa', 'tenis', 'tênis', 'sapato', 'sandália', 'sandalia', 'chinelo', 'salto', 'bota', 'carteira', 'óculos', 'oculos', 'brinco', 'colar'], ['vestido feminino', 'short feminino', 'conjunto feminino', 'blusa feminina', 'calça feminina', 'lingerie feminina', 'sutiã feminino']],
  ['fashion-intimates', 'Moda íntima, lingeries e sutiãs', 'lingerie feminina', ['lingerie', 'lingeries', 'moda íntima', 'moda intima', 'sutiã', 'sutia', 'calcinha', 'conjunto lingerie', 'body renda', 'camisola', 'baby doll', 'babydoll', 'robe feminino', 'cinta modeladora', 'pijama feminino'], ['cueca', 'masculino', 'infantil', 'menina', 'boneca', 'fantasia', 'biquíni', 'biquini'], ['lingerie feminina', 'sutiã feminino', 'calcinha feminina', 'conjunto lingerie', 'body renda feminino', 'camisola feminina', 'baby doll feminino']],
  ['fashion-footwear', 'Calçados femininos', 'tênis feminino', ['tênis', 'tenis', 'sapatilha', 'sapatilhas', 'rasteirinha', 'rasteirinhas', 'tamanco', 'tamancos', 'slide', 'slides', 'scarpin', 'scarpins', 'sapato salto', 'salto baixo', 'salto médio', 'salto medio', 'sandália feminina', 'sandalia feminina', 'mocassim feminino', 'bota feminina'], ['masculino', 'infantil', 'menino', 'chuteira', 'bola', 'bolsa', 'carteira', 'meia'], ['tênis feminino casual', 'sapatilha feminina', 'rasteirinha feminina', 'tamanco feminino', 'slide feminino', 'scarpin feminino', 'sapato salto feminino']],
